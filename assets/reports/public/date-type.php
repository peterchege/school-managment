...
<div id="content">
    <div id="content-header">
        ...
        <h1>Reports by Date and Fee type.</h1>
    </div><!--content-header-->
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-content">
                        <form action="date-type.php" method="post" class="form-horizontal">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <select name="type" class="span3 m-wrap">
                                        ...
                                        <?php while($type = mysqli_fetch_assoc($type_set)){?>
                                            <option><?php echo htmlentities($type['type']) ?></option>
                                        <?php } ?>
                ...
                <div class="widget-box">
                    <div class="widget-content">
                        ...
                        if(isset($_POST['date_export'])) {
                        ...
                        } elseif(isset($_POST['type_export'])){
                            ...
                            if ($payments_rows>= 1)  {
                                ...
                                $fee_payments_set = find_daily_payments_by_type($_SESSION['daily_date'], $_SESSION['daily_type']);
                                while($fee_payments = mysqli_fetch_assoc($fee_payments_set)){
                                    $data=$fee_payments ["id"] .",".$fee_payments['student_admin'] . "," . $fee_payments["registration"] .",". $fee_payments["surname"] .",".
                                        $fee_payments ["fullnames"] .",". $fee_payments["gender"] .",".
                                        $fee_payments["class"] ."," . $fee_payments['school'] . "," . $fee_payments["gname"] ."," . $fee_payments ["phone"] ."," .
                ...
                <?php if(isset($_POST['enter'])){?>
                    ...
                    <?php $type = mysqli_sec($_POST['type']); ?>
                    <?php $_SESSION['daily_type'] = $type; ?>
                    <?php if(!empty($date) && empty($type)){?>
                        <div class="widget-box">
                    ...
                    <?php }elseif (!empty($date) && !empty($type)) { ?>
                        <div class="widget-box">
                            <div class="widget-title">
                                <span class="icon"><i class="icon-th"></i></span>
                                <span class="icon_right">
                                ...
                                <span class="icon_right">
                                    <a href="reports/date-type-report.php" class="btn btn-mini btn-info" target="_blank">
                                        <i class="icon-print"></i> PRINT
                                    </a>
                                </span>
                                <span class="icon_right">
                                   <form method="post" class="form-horizontal">
                                       <button type="submit" name="type_export" class="btn btn-mini btn-info">
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <?php $total_type_paid = 0; ?>
                                    <?php $curent_type_set = find_daily_payments_by_type($date, $type); ?>
                                    <tbody>
                                    <?php while ($curent_type = mysqli_fetch_assoc($curent_type_set)) { ?>
                                        <tr>
                                            <td><?php echo htmlentities($curent_type['registration']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['fullnames']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['class']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['term']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['type']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['status']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['amount']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['paid']); ?> </td>
                                            <?php $total_type_paid += $curent_type['paid']; ?>
                                            <td><?php echo htmlentities($curent_type['balance']); ?> </td>
                                            <td><?php echo htmlentities($curent_type['date']); ?> </td>
                                        </tr>

                                    <?php } ?>
                                    <?php mysqli_free_result($curent_type_set); ?>
                                    </tbody>
                                </table>
                            </div>
                            <div class="widget-footer nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>TOTAL PAID: </th>
                                        <td><?php echo htmlentities($total_type_paid); ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
