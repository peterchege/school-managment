            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-content">
                        <form action="term-type-status.php" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">TYPE, TERM AND STATUS:</label>
                ...
                <div class="widget-box">
                    ...
                    if(isset($_POST['export'])){
                        ...
                        if ($payments_rows>= 1)  {
                            ...
                            $fee_payments_set = find_all_payments_by_type_term_and_status($_SESSION['term_type'], $_SESSION['term'], $_SESSION['term_status']);
                ...
                <?php if(isset($_POST['enter'])){?>
                    ...
                    ?>
                    <?php
                    $required_fields = array('type', 'term', 'status');
                    ...
                    if(empty($errors)){ ?>
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <span class="icon_right">n
                                    <a href="term-type-status.php" class="btn btn-mini btn-default">
                                        <i class="icon-refresh"></i> REFRESH
                                    </a>
                                </span>

                                <span class="icon_right">
                                    <a href="term_reports/current-type-term-and-status.php" class="btn btn-mini btn-primary" target="_blank">
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php $total_paid = 0;?>
                                    <?php $payments_set = find_all_payments_by_type_term_and_status($type, $term, $status); ?>
