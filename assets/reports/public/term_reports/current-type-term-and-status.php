...
$pdf -> Cell(40, 5, $_SESSION['term_type'], 0, 1);
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(10, 5, "TERM: ", 0, 0);
$pdf -> Cell(40, 5, $_SESSION['term'], 0, 1);
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(10, 5, "STATUS: ", 0, 0);
$pdf -> Cell(40, 5, $_SESSION['term_status'], 0, 1);
$pdf -> Cell(100, 3, '', 0);
$pdf -> Ln(20);
$pdf -> SetFont("Arial", 'B', 12);
$pdf -> Cell(70, 5, '', 0);
$pdf -> Cell(50, 5, "TERMLY REPORTS", 0, 1, 'L');
$pdf -> Ln(8);
$pdf -> SetFont("Arial", '', 9);
$total_paid = 0;
...
$pdf -> SetFont("Arial", '', 8);
$payment_set = find_all_payments_by_type_term_and_status($_SESSION['term_type'], $_SESSION['term'], $_SESSION['term_status']);
