            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-content">
                        <form action="class-type.php" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">BY TYPE AND CLASS:</label>
                ...
                <div class="widget-box">
                    ...
                    if(isset($_POST['export']))
                    {
                        ...
                        if ($payments_rows>= 1)  {
                            ...
                            $fee_payments_set =  find_payments_by_type($_SESSION['class_type'], $_SESSION['login_term']);
                    ...
                    elseif(isset($_POST['type-export']))
                    {
                        $fee_set = find_all_payments();
                        $payments_rows = mysqli_num_rows($fee_set);
                        if ($payments_rows>= 1)  {
                            ...
                            $fee_payments_set = find_payments_by_class_and_type($_SESSION['class_type'], $_SESSION['class']);
                            while($fee_payments = mysqli_fetch_assoc($fee_payments_set)){
                                $data=$fee_payments ["id"] .",".$fee_payments['student_admin'] . "," . $fee_payments["registration"] .",". $fee_payments["surname"] .",".
                                    $fee_payments ["fullnames"] .",". $fee_payments["gender"] .",".
                                    $fee_payments["class"] ."," . $fee_payments['school'] . "," . $fee_payments["gname"] ."," . $fee_payments ["phone"] ."," .
                ...
                <?php if(isset($_POST['enter'])){?>
                    ...
                    <?php if(!empty($type) && empty($class)){ ?>
                        ...
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <span class="icon_right">
                                    <a href="class_reports/type-term.php" class="btn btn-mini btn-primary" target="_blank">
                                        PRINT <i class="icon-print"></i>
                                    </a>
                                </span>

                                <span class="icon_right">
                                    <a href="class-type.php" class="btn btn-mini btn-default">
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php $total_paid = 0;?>
                                    <?php $payments_set =  find_payments_by_type($type, $_SESSION['login_term']); ?>
                    ...
                    <?php }elseif(!empty($type) && !empty($class)){?>
                        ...
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <span class="icon_right">
                                    <form action="class-type.php" method="post" class="form-horizontal">
                                        <button type="submit" name="type-export" class="btn btn-mini btn-info">
                                            <i class="icon-external-link"></i> EXPORT
                                        </button>
                                    </form>
                                </span>
                                ...
                                <span class="icon_right">
                                    <a href="class_reports/class-type-report.php" class="btn btn-mini btn-primary" target="_blank">
                                        PRINT <i class="icon-print"></i>
                                    </a>
                                </span>
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php $total_paid = 0;?>
                                    <?php $payments_set = find_payments_by_class_and_type($type, $class); ?>
                                    <?php while($payments = mysqli_fetch_assoc($payments_set)){?>
                                        <tr>
                                            <td><?php echo htmlentities($payments['registration']); ?></td>
                                            <td><?php echo htmlentities($payments['fullnames']); ?></td>
