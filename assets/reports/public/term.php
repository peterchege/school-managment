            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-content">
                        <form action="term.php" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">REPORTS BY TERM:</label>
                ...
                <div class="widget-box">
                    ...
                    if(isset($_POST['current'])){
                        ...
                        if ($payments_rows>= 1)  {
                            ...
                            $fee_payments_set = find_all_termly_payments_by_status($_SESSION['term'], $_SESSION['term_status']);
                            while($fee_payments = mysqli_fetch_assoc($fee_payments_set)){
                                $data=$fee_payments ["id"] .",".$fee_payments['student_admin'] . "," . $fee_payments["registration"] .",". $fee_payments["surname"] .",".
                                    $fee_payments ["fullnames"] .",". $fee_payments["gender"] .",".
                                    $fee_payments["class"] ."," . $fee_payments['school'] . "," . $fee_payments["gname"] ."," . $fee_payments ["phone"] ."," .
                    ...
                    }elseif(isset($_POST['current-status-report'])){
                        $fee_set = find_all_payments();
                        $payments_rows = mysqli_num_rows($fee_set);
                        if ($payments_rows>= 1)  {
                            $file = "exports/". strtotime(now) . ".csv";
                            ...
                            $fee_payments_set = find_all_termly_payments_by_status($_SESSION['login_term'], $_SESSION['term_status']);
                            while($fee_payments = mysqli_fetch_assoc($fee_payments_set)){
                                $data=$fee_payments ["id"] .",".$fee_payments['student_admin'] . "," . $fee_payments["registration"] .",". $fee_payments["surname"] .",".
                                    $fee_payments ["fullnames"] .",". $fee_payments["gender"] .",".
                                    $fee_payments["class"] ."," . $fee_payments['school'] . "," . $fee_payments["gname"] ."," . $fee_payments ["phone"] ."," .
                ...
                <?php if(isset($_POST['enter'])){?>
                    ...
                    $_SESSION['term_status'] = $status;

                    ?>

                    <?php if(!empty($term) AND empty($status)){?>
                        ...
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <span class="icon_right">
                                    <a href="term.php" class="btn btn-mini btn-default">
                    ...
                    <?php }elseif(!empty($term) AND !empty($status)){?>
                        <div class="widget-box">
                            <div class="widget-title">
                                <span class="icon">
                                    <i class="icon-th"></i>
                                ...
                                <span class="icon_right">
                                    <a href="term_reports/status_report.php" class="btn btn-mini btn-primary" target="_blank">
                                        PRINT <i class="icon-print"></i>
                                    </a>
                                </span>
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php $total_paid = 0;?>
                                    <?php $payments_set = find_all_termly_payments_by_status($term, $status); ?>
                                    <?php while($payments = mysqli_fetch_assoc($payments_set)){?>
                                        <tr>
                                            <td><?php echo htmlentities($payments['registration']); ?></td>
                                            <td><?php echo htmlentities($payments['fullnames']); ?></td>
                    ...
                    <?php }elseif(empty($term) AND !empty($status)){?>
                        ...
                        <div class="widget-box">
                            <div class="widget-title">
                                ...
                                <span class="icon_right">
                                    <a href="term_reports/curent-status.php" class="btn btn-mini btn-primary" target="_blank">
                                        PRINT <i class="icon-print"></i>
                                    </a>
                                </span>
                                ...
                                <span class="icon_right">
                                    <form action="term.php" method="post" class="form-horizontal">
                                        <button type="submit" name="current-status-report" class="btn btn-mini btn-info">
                                            <i class="icon-external-link"></i> EXPORT
                                        </button>
                                    </form>
                                </span>
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <?php $total_paid = 0;?>
                                    <?php $payments_set = find_all_termly_payments_by_status($_SESSION['login_term'], $status); ?>
                                    <?php while($payments = mysqli_fetch_assoc($payments_set)){?>
                                        <tr>
                                            <td><?php echo htmlentities($payments['registration']); ?></td>
                                            <td><?php echo htmlentities($payments['fullnames']); ?></td>
