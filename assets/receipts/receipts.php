...
<?php
    ...
    //$totalpaidamount = $_GET['paid'];
    //$totaltermamount = $_GET['tamount'];
    //$tbalance = $totaltermamount - $totalpaidamount;
?>
...
$pdf -> Cell(22, 5, 'TOTAL BALANCE', 0);
$pdf -> SetFont("Arial", "", 10);
$pdf -> Cell(30, 5, ''.$_GET['tamount']-$_GET['paid'], 0, 1);
