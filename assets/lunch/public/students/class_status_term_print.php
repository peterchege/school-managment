...
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(12, 4, "STATUS: ", 0);
$pdf -> Cell(40, 4, $_SESSION['lunch_payments_status'], 0, 1);
$pdf -> Cell(130, 3, '', 0);
$pdf -> Cell(12, 4, "TERM: ", 0);
$pdf -> Cell(40, 4, $_SESSION['lunch_payments_term'], 0, 1);
$pdf -> Cell(100, 3, '', 0);
...
$payment_set = find_payments_by_class_and_status($_SESSION['lunch_class_payments'], $_SESSION['lunch_payments_status'], $_SESSION['lunch_payments_term']);
$total_amount = 0;
$total_paid = 0;
//$total_balance = 0;
