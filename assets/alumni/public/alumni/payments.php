                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered table-invoice-full">
                            ...
                            <?php $total_paid = 0; ?>
                            <?php $payments_set = find_student_payments($current_alumni_id['admin_number']); ?>
                            <?php while($payments= mysqli_fetch_assoc($payments_set)){ $num_rows = mysql_num_rows($payments);?>
                ...
                <div class="widget-box">
                    <div class="widget-content nopadding">
                        ...
                        <div class="pull-right">
                            ...
                            </a><a href="paynow.php?alumni=<?php echo urlencode($current_alumni_id['id']); ?>&&amount=<?php echo $total_balance ?>&&reg=<?php echo $reg; ?>" class="btn btn-success pull-right">
                                <i class="icon-credit-card"></i> PAY BALANCE: KSH.<?php echo $total_balance ?>.00
                            </a>
