...
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(20, 5, "START DAY: ", 0, 0);
$pdf -> Cell(40, 5, $_SESSION['strt'], 0, 1);
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(20, 5, "END DATE: ", 0, 0);
$pdf -> Cell(40, 5, $_SESSION['end'], 0, 1);
$pdf -> Cell(100, 3, '', 0);
$pdf -> Ln(20);
$pdf -> SetFont("Arial", 'B', 12);
$pdf -> Cell(70, 5, '', 0);
$pdf -> Cell(50, 5, "STOCK PAYMENTS RANGE REPORTS", 0, 1, 'L');
$pdf -> Ln(8);
$pdf -> SetFont("Arial", '', 9);
$total_paid = 0;
...
$pdf -> SetFont("Arial", '', 8);
$payment_set = find_payments_by_date_range($_SESSION['strt'], $_SESSION['end']);
