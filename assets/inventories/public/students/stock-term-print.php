...
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(12, 5, "STOCK: ", 0, 0);
$pdf -> Cell(40, 5, $_SESSION['stock'], 0, 1);
$pdf -> Cell(130, 4, '', 0);
$pdf -> Cell(12, 5, "TERM: ", 0, 0);
$pdf -> Cell(40, 5, $_SESSION['stock_term'], 0, 1);
$pdf -> Cell(100, 3, '', 0);
$pdf -> Ln(20);
$pdf -> SetFont("Arial", 'B', 12);
$pdf -> Cell(70, 5, '', 0);
$pdf -> Cell(50, 5, "STOCK PAYMENTS REPORTS", 0, 1, 'L');
$pdf -> Ln(8);
$pdf -> SetFont("Arial", '', 9);
$total_paid = 0;
...
$pdf -> Cell(17, 5, 'STOCK', 1, 0);
$pdf -> Cell(12, 5, 'SIZE', 1, 0);
$pdf -> Cell(10, 5, 'QTY', 1, 0);
$pdf -> Cell(22, 5, 'T-AMOUNT', 1, 0);
$pdf -> Cell(17, 5, 'PAID', 1, 0);
$pdf -> Cell(15, 5, 'BAL', 1);
$pdf -> Cell(18, 5, 'DATE', 1, 1);
$pdf -> SetFont("Arial", '', 8);
$payment_set = find_stocks_payments_by_stock_and_term($_SESSION['stock'], $_SESSION['stock_term']);
while($payments = mysqli_fetch_assoc($payment_set)){
    ...
    $pdf -> Cell(17, 5, $payments['stock'], 1, 0);
    $pdf -> Cell(12, 5, $payments['size'], 1, 0);
    $pdf -> Cell(10, 5, $payments['quantity'], 1, 0);
    $pdf -> Cell(22, 5, $payments['total_amount'], 1, 0);
    $pdf -> Cell(17, 5, $payments['paid'], 1, 0);
    $total_paid += $payments['paid'];
    $pdf -> Cell(15, 5, $payments['balance'], 1, 0);
    $pdf -> Cell(18, 5, $payments['date'], 1, 1);
}
