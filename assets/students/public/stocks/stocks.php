                ...
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <span class="icon_right">
                            <a href="stockrec.php?stock=<?php echo urlencode($current_student_admin['admin']) ?>&name=<?php echo htmlentities($current_student_admin['full_names']); ?>" class="btn btn-mini btn-info" target="_blank">
