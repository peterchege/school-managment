            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="confirm.php?payments=<?php echo urlencode($current_payments['id']); ?>" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="amount" id="amount"  value="<?php echo htmlentities($amount); ?>" placeholder="fee type amount" disabled="" class="span11" onkeyup="sum();">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" value="<?php echo htmlentities($current_payments['status']); ?>" name="payments" class="span11">
                                </div>
                            </div>
