...
<?php if(!$current_payments){ redirect_to('transport-invoice.php');} ?>
<?php
...
$pdf -> Cell(12, 5, 'ROUTE:', 0);
$pdf -> Cell(25, 5, ''.$current_payments['route'], 0, 1);

$pdf -> Cell(15, 5, 'PAYMENTS:', 0);
$pdf -> Cell(25, 5, ''.$current_payments['payments'], 0, 1);
...
$pdf -> Cell(22, 5, 'BALANCE:', 0);
$pdf -> Cell(30, 5, ''.$current_payments['balance'], 0, 0);
$pdf -> Ln(5);
